...
*   **Отказ от поддержки старых архитектур**: Поддерживается только arm64-v8a.
...
*   **Ядерный обход биндов**: Возможность разворачивать пакеты напрямую в обход любых биндов приложений на уровне ядра.
